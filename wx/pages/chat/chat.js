...
Page({
  ...
  send: function () {
    var _this = this;
    var send_data=encodeURI(this.data.InputValue);
    if (this.data.InputValue) {
      ...
      wx.request({
        url: 'http://localhost:80/hjbServlet',
        method: 'get',
        header: {
          'content-type': '"text/html; charset=UTF-8"application/x-www-form-urlencoded;charset=utf-8', // 默认值
